...
<body>
    <div class="container">
        <h2 class="title">مولد SHA-1</h2>
        <textarea id="inputText" placeholder="أدخل النص هنا..." spellcheck="false"></textarea>
        <button class="btn-generate" onclick="generateSHA1()">توليد SHA-1</button>
    ...
    <script src="javascript/SHA-1.js?v=2.1"></script>
</body>
</html>
