...
.header-links a.active::after {
    ...
    <a href="cybersecurity.php" class="<?php echo ($currentPage == 'cybersecurity.php') ? 'active' : ''; ?>">
        <span>مقدمة عن الأمن السيبراني</span>
        <i class="fas fa-shield-alt icon"></i>

    </a>
    
    <a href="crypto.php" class="<?php echo ($currentPage == 'crypto.php') ? 'active' : ''; ?>">
        <span>التشفير</span>
        <i class="fas fa-lock icon"></i>

    </a>
    
    <a href="vulnerability.php" class="<?php echo ($currentPage == 'vulnerability.php') ? 'active' : ''; ?>">
        <span>الثغرات</span>
        <i class="fas fa-bug icon"></i>

    </a>
    
    <a href="exploittools.php" class="<?php echo ($currentPage == 'exploittools.php') ? 'active' : ''; ?>">
        <span>أدوات الاختراق</span>
        <i class="fas fa-tools icon"></i>

    </a>
    
    <a href="MITRE_ATT&CK.php" class="<?php echo ($currentPage == 'MITRE_ATT&CK.php') ? 'active' : ''; ?>">
        <span> MITRE ATT&CK</span>
        <i class="fas fa-chess-board icon"></i>

    </a>
    
    <a href="NetworkS.php" class="<?php echo ($currentPage == 'NetworkS.php') ? 'active' : ''; ?>">
        <span>أمن الشبكات </span>
        <i class="fas fa-network-wired icon"></i>

    </a>
    <a href="CTF_learn.php" class="<?php echo ($currentPage == 'CTF_learn.php') ? 'active' : ''; ?>">
        <span>ما هو CTF</span>
