...
$currentPage = basename($_SERVER['PHP_SELF']); // لمعرفة الصفحة الحالية
?>
<!DOCTYPE html>
...
<header dir="rtl">
    ...
    <a href="challenges.php" class="<?php echo ($currentPage == 'challenges.php') ? 'active' : ''; ?>">
        <i class="fas fa-trophy"></i> التحديات
    </a>
    <a href="leaderboard.php" class="<?php echo ($currentPage == 'leaderboard.php') ? 'active' : ''; ?>">
        <i class="fas fa-chart-line"></i> المتصدرين
    </a>
</div>

    <!-- شعار يعيد المستخدم إلى الرئيسية -->
