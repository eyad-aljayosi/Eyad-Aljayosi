...
<header>
    ...
    <div class="header-links">
        <a href="subbstitution.php" class="<?php echo ($currentPage == 'subbstitution.php') ? 'active' : ''; ?>">subbstitution</a>
        <a href="Caesar_Cipher.php" class="<?php echo ($currentPage == 'Caesar_Cipher.php') ? 'active' : ''; ?>">Caesar Cipher</a>
        <a href="File_encryption.php" class="<?php echo ($currentPage == 'File_encryption.php') ? 'active' : ''; ?>">تشفير الملفات</a>
        <a href="AES.php" class="<?php echo ($currentPage == 'AES.php') ? 'active' : ''; ?>">تشفير AES</a>
        <a href="RSA.php" class="<?php echo ($currentPage == 'RSA.php') ? 'active' : ''; ?>">تشفير RSA</a>

        
        <a href="view_activities.php" class="<?php echo ($currentPage == 'view_activities.php') ? 'active' : ''; ?>">عرض انشطتك</a>
