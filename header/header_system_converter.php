...
<html lang="ar" dir="rtl">
    <meta charset="UTF-8">
    <link rel="stylesheet" href="css-header/style-header_system_converter.css">
   ...
   body {
    ...
    .logo img {
        ...
        height: 46px; /* تم تكبير الحجم إلى 60px (يمكنك تعديله حسب الحجم المطلوب) */
...
<header>
    ...
    <div class="header-links">
        <a href="multi_system_converter.php" class="<?php echo ($currentPage == 'multi_system_converter.php') ? 'active' : ''; ?>">محول الأنظمة الرقمية والنصوص</a>
    </div>
