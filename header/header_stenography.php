...
<html lang="ar" dir="rtl">
    <meta charset="UTF-8">
    <link rel="stylesheet" href="css-header/style-header_stenography.css">
...
<header>
    ...
    <div class="header-links">
        <a href="steganography.php" class="<?php echo ($currentPage == 'steganography.php') ? 'active' : ''; ?>">Hide steganography</a>
        <a href="Steganography_Reveal.php" class="<?php echo ($currentPage == 'Steganography_Reveal.php') ? 'active' : ''; ?>">Analyze Steganography</a> 
